  ...
  return (
    ...
    >
      ...
      <div className="w-[160px] h-12 space-x-2 flex items-center mb-4">
        <p
          className={`text-h3 text-primary group-hover:text-white capitalize ${
            svg ? "text-white" : ""
          }`}
        >
          {props.name}
        ...
        <p
          className={`"text-body_st_md text-gray_4 group-hover:text-gray_3 uppercase ${
            svg ? "text-gray_3" : ""
          }`}
        >
          {props.aka}
      ...
      <p
        className={`text-body_sm_rg text-center text-gray_3 group-hover:text-gray_4 mb-6 ${
          svg ? "text-gray_4" : ""
        }`}
      >
        {props.description}
