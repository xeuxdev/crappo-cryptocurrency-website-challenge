...
const CryptoCard = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      {svg ? <SvgButton name="Start mining" /> : <InitBtn />}
    </div>
  )
}
...
function InitBtn() {
  return (
    <div className="w-16 h-16 rounded-full grid place-items-center border-2 border-[hsla(261,88%,23%,0.2)]  group-hover:border-gray_3 relative">
      <svg
        width="48"
        height="48"
        viewBox="0 0 48 48"
